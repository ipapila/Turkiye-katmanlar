...
Tüm tarayıcılar için standart GeoJSON üretici.
...
def feature_collection(name: str, features: list, metadata: dict = None) -> dict:
...
# İl merkezi koordinatları — geocoder yokken fallback
IL_KOORDINATLARI = {
...
def il_koordinat(il_adi: str) -> tuple[float, float]:
